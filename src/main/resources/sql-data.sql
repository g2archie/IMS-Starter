...
INSERT INTO `ims`.`orders` (`order_time`, `cust_id`) VALUES (0, 1);
INSERT INTO `ims`.`orders` (`order_time`, `cust_id`) VALUES (1000000, 1);
INSERT INTO `ims`.`orders` (`order_time`, `cust_id`) VALUES (2000000, 2);
